...
def smi_info(smi):
        ...
        return smi,m_qed,m_logP,m_Wt ,m_TPSA,m_RotatableBonds,m_HBD,m_HBA,m_NumRings,m_AromaticRings,m_CSP3,m_HeavyAtoms,0
...
if __name__=="__main__":
    ...
    #smi_train_list  = [ smi[:-1] for smi in smi_train_list if "+" not in smi and "-" not in smi][:1000]
    

    #color_train = [0 for x in  smi_train_list][:1000]
    ...
    #smi_list = list(csv_data["Smi"])[:1000]  

    #color = [1 for x in smi_list][:1000]
