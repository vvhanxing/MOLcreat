...
def generate(decoder, prime_str='1', predict_len=25,E=0.0 ,temperature=0.8, cuda=False):
...
# Parse command line arguments
    ...
    argparser.add_argument('-filename', type=str,default="ZINC250K_train.txt")
    ...
    while count<80:
        ...
        txt = generate(decoder, "2",25,0.0,0.9,cuda=args.cuda).split(" 0 ")[0]
        count+=1
